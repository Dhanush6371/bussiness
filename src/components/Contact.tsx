          ...
          <div className="lg:w-1/3 bg-indigo-600 text-white p-8 lg:p-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-indigo-100 mt-1">123 Creative Street, San Francisco, CA 94103</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-indigo-100 mt-1">hello@pixelperfect.com</p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-indigo-700 hover:bg-indigo-800 h-10 w-10 rounded-full flex items-center justify-center transition-colors">
          ...
          <div className="lg:w-2/3 p-8 lg:p-12 bg-white">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                ...
                className={`bg-indigo-600 text-white px-8 py-3 rounded-md hover:bg-indigo-700 transition-colors flex items-center justify-center ${
